...
personality_plugins "all,-ant,-gradle,-scalac,-scaladoc,-asflicense,-javadoc,-spotbugs,-shelldocs"
...
function personality_modules
{
  ...
  extra="-Ptest-patch -DignoreTestFailure=true -DbatsFailOnError=false ${extra}"
