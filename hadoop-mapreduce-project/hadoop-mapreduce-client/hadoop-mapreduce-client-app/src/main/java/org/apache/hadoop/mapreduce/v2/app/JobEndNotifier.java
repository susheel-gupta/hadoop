...
public class JobEndNotifier implements Configurable {
  ...
  protected String customJobEndNotifierClassName; //A custom notifier implementation (see org.apache.hadoop.mapreduce.CustomJobEndNotifier)
  ...
  private boolean notifyViaCustomNotifier() {
    try {
      ...
      final Class<? extends CustomJobEndNotifier> customJobEndNotifierClass =
          Class.forName(customJobEndNotifierClassName).asSubclass(CustomJobEndNotifier.class);
      final CustomJobEndNotifier customJobEndNotifier = customJobEndNotifierClass.newInstance();
