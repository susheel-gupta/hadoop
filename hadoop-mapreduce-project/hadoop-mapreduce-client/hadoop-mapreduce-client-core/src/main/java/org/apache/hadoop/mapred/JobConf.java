...
public class JobConf extends Configuration {
  ...
  /**
   * Returns the class to be invoked in order to send a notification after the job
   * has completed (success/failure).
   *
   ...
   * {@link org.apache.hadoop.mapreduce.CustomJobEndNotifier#notifyOnce(java.net.URL, org.apache.hadoop.conf.Configuration)}
   * along with the Job's conf.
   *
   * If this is set instead of using a simple HttpURLConnection we'll create a new instance of this class
   * which should be an implementation of {@link org.apache.hadoop.mapreduce.CustomJobEndNotifier},
   * and we'll invoke that.
   *
   * @param customNotifierClassName the fully-qualified name of the class which implements
