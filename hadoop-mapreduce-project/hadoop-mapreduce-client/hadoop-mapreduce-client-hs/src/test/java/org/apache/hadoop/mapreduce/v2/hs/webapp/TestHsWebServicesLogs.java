...
public class TestHsWebServicesLogs extends JerseyTestBase {
      ...
      try {
        doAnswer(invocationOnMock -> {
          GetApplicationReportRequest request =
              (GetApplicationReportRequest) invocationOnMock.getArguments()[0];
        ...
        doAnswer(invocationOnMock -> {
          GetContainerReportRequest request =
              (GetContainerReportRequest) invocationOnMock.getArguments()[0];
  ...
  public void testGetAggregatedLogsMetaForFinishedApp() {
    ...
    for (ContainerLogsInfo logsInfo : responseList) {
      ...
      assertThat(logsInfo.getLogType(), equalTo(
          ContainerLogAggregationType.AGGREGATED.toString()));

      if (cId.equals(CONTAINER_1_1_3.toString())) {
        assertThat(logsInfo.getNodeId(), equalTo(formatNodeId(NM_ID_2)));
      } else {
        assertThat(logsInfo.getNodeId(), equalTo(formatNodeId(NM_ID_1)));
      }
  ...
  public void testGetContainerLogsForFinishedContainer() {
    ...
    List<ContainerLogsInfo> responseText =
        response.getEntity(new GenericType<List<ContainerLogsInfo>>(){});
    assertThat(responseText.size(), is(1));

    ContainerLogsInfo logsInfo = responseText.get(0);
    assertThat(logsInfo.getLogType(), equalTo(
        ContainerLogAggregationType.AGGREGATED.toString()));
    assertThat(logsInfo.getContainerId(), equalTo(CONTAINER_1_1_2.toString()));
  ...
  public void testGetContainerLogsForRunningContainer() throws Exception {
    ...
    assertThat(redirectURL, IsNull.notNullValue());
    assertThat(redirectURL, containsString(NM_WEBADDRESS_1));
    assertThat(redirectURL, containsString("ws/v1/node/containers"));
    assertThat(redirectURL, containsString(CONTAINER_2_2_2.toString()));
    assertThat(redirectURL, containsString("/logs"));
    ...
    assertThat(redirectURL, IsNull.notNullValue());
    assertThat(redirectURL, containsString(NM_WEBADDRESS_2));
    assertThat(redirectURL, containsString("ws/v1/node/containers"));
    assertThat(redirectURL, containsString(CONTAINER_2_2_2.toString()));
    assertThat(redirectURL, containsString("/logs"));
    ...
    List<ContainerLogsInfo> responseText =
        response.getEntity(new GenericType<List<ContainerLogsInfo>>(){});
    assertThat(responseText.size(), is(2));
    ...
    assertThat(logsInfo1.getContainerId(),
        equalTo(CONTAINER_2_2_3.toString()));
    assertThat(logsInfo2.getContainerId(),
        equalTo(CONTAINER_2_2_3.toString()));

    if (logsInfo1.getLogType().equals(
        ContainerLogAggregationType.AGGREGATED.toString())) {
      assertThat(logsInfo2.getLogType(), equalTo(
      ...
      assertThat(logsInfo2.getContainerLogsInfo(), IsNull.nullValue());
    } else {
      assertThat(logsInfo1.getLogType(), equalTo(
          ContainerLogAggregationType.LOCAL.toString()));
      assertThat(logsInfo2.getLogType(), equalTo(
          ContainerLogAggregationType.AGGREGATED.toString()));

      // this information can be only obtained by the NM.
      assertThat(logsInfo1.getContainerLogsInfo(), IsNull.nullValue());
  ...
  public void testGetContainerLogFileForFinishedContainer() {
    ...
    assertThat(responseText, not(containsString("Can not find logs")));
    assertThat(responseText, not(containsString("Hello-" + CONTAINER_1_1_1)));
  }
  ...
  public void testNoRedirectForFinishedContainer() throws Exception {
    ...
    String redirectURL = getRedirectURL(requestURI.toString());
    assertThat(redirectURL, IsNull.nullValue());
  }
  ...
  public void testGetContainerLogFileForRunningContainer() throws Exception {
    ...
    assertThat(redirectURL, containsString("ws/v1/node/containers"));
    assertThat(redirectURL, containsString(CONTAINER_2_2_2.toString()));
    assertThat(redirectURL, containsString("/logs/" + FILE_NAME));
    ...
    assertThat(responseText, containsString("LogAggregationType: "
        + ContainerLogAggregationType.AGGREGATED));
    assertThat(responseText, containsString("Hello-" + CONTAINER_2_2_3));
  }
  ...
  public void testNonExistingAppId() {
    ...
    assertThat(responseText, containsString("Can not find"));
  }
  ...
  public void testBadAppId() {
    ...
    assertThat(responseText, containsString("Invalid ApplicationId"));
  }
  ...
  public void testBadAppAttemptId() {
    ...
    assertThat(responseText, containsString(
        BadRequestException.class.getSimpleName()));
    assertThat(responseText, containsString("Invalid AppAttemptId"));
  }
  ...
  public void testBadContainerId() {
    ...
    assertThat(responseText, containsString(
        BadRequestException.class.getSimpleName()));
    assertThat(responseText, containsString("Invalid ContainerId"));
  }
  ...
  public void testBadContainerForMeta() {
    ...
    assertThat(responseText, containsString(
        BadRequestException.class.getSimpleName()));
    assertThat(responseText, containsString("Invalid container id"));
  }

  private static void assertSimpleContainerLogFileInfo(
      ContainerLogsInfo logsInfo, String cId) {
    assertThat(logsInfo.getContainerLogsInfo(), IsNull.notNullValue());
    assertThat(logsInfo.getContainerLogsInfo().size(), is(1));
    ContainerLogFileInfo fileInfo = logsInfo.getContainerLogsInfo().get(0);
    assertThat(fileInfo.getFileName(), equalTo(FILE_NAME));
    assertThat(fileInfo.getFileSize(), is(
  ...
  private static void assertResponseList(List<ContainerLogsInfo> responseList,
    ...
    assertThat(actualStrings, equalTo(expectedIdStrings));

    int expectedSize = expectedIdStrings.size();
    assertThat(responseList.size(), is(
