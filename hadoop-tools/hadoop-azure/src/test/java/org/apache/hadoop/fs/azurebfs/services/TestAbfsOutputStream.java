...
public final class TestAbfsOutputStream {
  ...
  public void verifyShortWriteRequest() throws Exception {
    ...
    when(client.append(anyString(), any(byte[].class), any(AppendRequestParameters.class), anyString())).thenReturn(op);
    when(client.flush(anyString(), anyLong(), anyBoolean(), anyBoolean(), anyString(), isNull(String.class))).thenReturn(op);
  ...
  public void verifyWriteRequestOfBufferSizeWithAppendBlob() throws Exception {
    ...
    when(client.getAbfsPerfTracker()).thenReturn(tracker);
    when(client.append(anyString(), any(byte[].class), any(AppendRequestParameters.class), any())).thenReturn(op);
    when(client.flush(anyString(), anyLong(), anyBoolean(), anyBoolean(), any(), isNull(String.class))).thenReturn(op);
