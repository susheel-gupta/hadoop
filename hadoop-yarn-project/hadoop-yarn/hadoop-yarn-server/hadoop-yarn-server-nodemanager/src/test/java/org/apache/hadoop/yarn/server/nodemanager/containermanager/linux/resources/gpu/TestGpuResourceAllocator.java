...
public class TestGpuResourceAllocator {
  ...
  private static class ContainerMatcher extends BaseMatcher<Container> {
    ...
    public boolean matches(Object other) {
      ...
      long otherId = ((Container) other).getContainerId().getContainerId();
      return expectedId == otherId;
    }

    @Override
    public void describeTo(org.hamcrest.Description description) {
      description.appendText("Container ID: " + container.getContainerId());
    }
  }
